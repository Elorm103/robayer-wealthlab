/**
 * Unit tests: epubChapterService.ts - Secure Digital Library, Phase 5.
...
describe('renderProtectedEpubChapter() - the core security property', () => {
  ...
  it('preserves the exact strict EPUB CSP, including script-src \'none\' - never weakened for the secure path', async () => {
