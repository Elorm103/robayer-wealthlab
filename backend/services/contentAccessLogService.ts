/**
 * Content Access Log - Secure Digital Library, audit trail. One
 ...
 * page/chapter/download response, the same "log, don't throw"
 * discipline emailService.ts's sendEmail() already guarantees
 * elsewhere in this codebase). Never logs rendered content itself -
 * `metadata` is a small, deliberately narrow JSON object.
 */
