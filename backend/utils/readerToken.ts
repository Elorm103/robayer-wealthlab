/**
 * Reader session token generation and hashing - Controlled Library
 * Reader, Phase 2. Mirrors downloadToken.ts's own 256-bit Web Crypto
 ...
 * reader_sessions.session_token_hash never stores the raw token - the
 * real token is returned to the customer exactly once, at mint time,
 * and never persisted anywhere in that form again.
 */
